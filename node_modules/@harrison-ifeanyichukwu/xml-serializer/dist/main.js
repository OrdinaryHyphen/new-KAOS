        ...
        */
        ...
        createClass(Serializer, [{
            ...
            value: function validateXMLNameProduction(value) {
                ...
                var regex = new RegExp('^(' + nameStart + ')(' + nameChar + ')*', 'i');
            ...
            */
            ...
            value: function validatePublicId(pubId) {
                ...
                var regex = new RegExp('^(' + pubIdChar + ')*$');
            ...
            value: function recordElementNSInfo(elem, prefixMap, elmPrefixList) {
                ...
                while (++i < len) {
                    ...
                    if (attrNS === XMLNS_NS) {
                        ...
                        //STEP 2.3.2.3
                        if (typeof prefixMap[nsDef] !== 'undefined' && prefixMap[nsDef] === prefixDef) this.dupPrefixDef.push(prefixDef);
            ...
            */
            ...
            value: function serializeAttributes(node, map, ignoreNSDefAttr, requireWellFormed) {
                ...
                while (++i < len) {
                    ...
                    var tuple = [nsURI, localName];
                    //STEP 3.1
                    /* istanbul ignore if */
                    if (requireWellFormed && this.tupleExists(localNameSet, tuple)) throw new Error('element cannot have two attributes with the same namespaceURI and localName');
                    ...
                    //STEP 3.8
                    /* istanbul ignore if */
                    if (requireWellFormed && !this.validateXMLAttrName(localName, attrNS)) throw new Error(localName + ' is not a valid xml attribute name');
            ...
            */
            ...
            value: function serializeProcessingInstruction(node, requireWellFormed) {
                //STEP 1
                if (requireWellFormed && !this.validatePITarget(node.target)) throw new Error(node.target + ' is not a valid processing instruction target value');
            ...
            */
            ...
            value: function serializeDocumentType(docType, requireWellFormed) {
                //STEP 1
                if (requireWellFormed && !this.validatePublicId(docType.publicId)) throw new Error(docType.publicId + ' contains invalid xml document pubId character value');

                //STEP 2
                if (requireWellFormed && !this.validateSystemId(docType.systemId)) throw new Error(docType.systemId + ' contains invalid xml document systemId character value');
                ...
                if (publicId === '' && systemId === '' && /^html$/i.test(docType.name)) markup += docType.name.toLowerCase();else markup += docType.name;
            ...
            */
            ...
            value: function serializeDocument(node, namespace, prefixMap, requireWellFormed) {
                ...
                var serializeDocument = '<?xml version="1.0" encoding="' + node.characterSet + '"?>';
            ...
            */
            ...
            value: function serializeElement(node, namespace, prefixMap, requireWellFormed) {
                ...
                /* istanbul ignore if */
                if (requireWellFormed && !this.validateXMLTagName(localName)) throw new Error(localName + ' is not a valid xml element local name');
